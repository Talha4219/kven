 ...
 * `kven://hire?src=<https-url>` deep link or an in-app file picker.
 *
...
export const HIRE_SPEC_V1 = 'kven/hire@1';
...
export interface HireManifest {
  /** Spec tag; exactly `kven/hire@1` for this version. */
  ...
  goal?: string;
  /** Cast sprite id (e.g. 'aria'); unknown values fall back to default. */
  character?: string;
...
/** Parse a `kven://hire?src=<https-url>` deep link. Returns the https
...
export function parseHireDeepLink(link: string): string | null {
  ...
  if (u.protocol !== 'kven:') return null;
  // Both kven://hire?src= (host) and kven:hire?src= (path).
