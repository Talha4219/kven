...
export interface HarnessConfig {
  ...
  defaultModel?: string;
  /** Which provider powers the GOD orchestrator ("Bro"). The persona is
  ...
  /** Master toggle for the Slack → Bro's-queue integration. */
  ...
  // ─── Realtime Bro (premium speech-to-speech voice orchestrator) ─────────
  /** True ONLY while a Realtime Bro voice session is live: the renderer
   ...
   *  tunes this in Settings → Realtime Bro. */
