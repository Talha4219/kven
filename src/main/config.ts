...
export interface HarnessConfig {
  ...
  defaultModel?: string;
  /** Which provider powers the GOD orchestrator ("Aria"). The persona is
  ...
  /** Master toggle for the Slack → Aria's-queue integration. */
  ...
  // ─── Realtime Aria (premium speech-to-speech voice orchestrator) ─────────
  /** True ONLY while a Realtime Aria voice session is live: the renderer
   ...
   *  tunes this in Settings → Realtime Aria. */
