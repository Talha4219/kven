/**
 * Realtime Bro — voice ACTION tools (card rt-5, Phase 2).
 *
 * The write-side function-tools that turn voice-Bro into an orchestrator: ping
 ...
 * rule, the hard allowlist (kill-god / mass-ops forbidden), and the bro-voice
