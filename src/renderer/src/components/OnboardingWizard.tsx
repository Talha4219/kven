                ...
                <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: 'var(--cth-ink-700)', lineHeight: '19px' }}>
                      Kven turns the CLI agent you already use into a clone of you —
            ...
            {step === 'permissions' && (
              <>
                ...
                <ToggleRow
                  ...
                  desc="A handful of anonymous events (app opened, agent spawned, feature used) that help improve Kven — never prompts, code, file paths, or agent output. Full list in TELEMETRY.md; change anytime in Settings."
                  on={shareStats}
