...
Munder Difflin is built on **Electron · React · TypeScript · Pixi.js · xterm.js · node-pty**, and it's **local-first** and **source-available**. Your agents run on your machine, on your Claude plan.
