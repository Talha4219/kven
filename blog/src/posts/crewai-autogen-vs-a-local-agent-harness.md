...
faq:
  ...
  - q: "Is Munder Difflin a framework I can import into my own app?"
    a: "No. It's a local-first, source-available Electron desktop app for macOS, Windows, and Linux — the harness itself is the product. You download it, spawn agents that run as real CLI processes in isolated git worktrees, and a GOD orchestrator routes work between them while you watch, with approvals, budgets, a circuit breaker, and shared memory already wired in."
---
